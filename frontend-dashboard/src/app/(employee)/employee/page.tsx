...
const OperatorDashboard = () => {
    ...
    if (authLoading || !user) {
        return (
            <Box sx={{  minHeight: "100vh", color: "white", p: 2 }}>
                    ...
                    <Grid container spacing={3} sx={{ marginTop: '2em', p: { xs: 2, md: 4 } }}>
                        ...
                        <Grid item xs={12} md={8}>
                            {editMode ? (
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Carnet</Typography>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Nombre</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
                                            {formData.first_name}
                                        </Typography>
                                        <Divider sx={{  my: 2 }} />
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Apellido</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
                                            {formData.last_name}
                                        </Typography>
                                        <Divider sx={{  my: 2 }} />
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Correo electrónico</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
                                            {formData.email}
                                        </Typography>
                                        <Divider sx={{  my: 2 }} />
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Celular</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Turno</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Grupo</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="subtitle2"  sx={{ mb: 0.5 }}>Rol</Typography>
                                        <Typography variant="body1" sx={{ fontWeight: 'medium', fontSize: '1rem' }}>
